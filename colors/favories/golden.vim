...
" Cwhiteits: This color scheme originated from the idea of 
...
hi ErrorMsg		  term=standout  cterm=bold  ctermfg=White  ctermbg=white  guifg=White  guibg=white
hi Search		  term=reverse	ctermfg=white  ctermbg=white	guifg=white  guibg=white
...
hi Constant		  term=underline  cterm=bold ctermfg=white  guifg=white
hi Special		  term=bold  cterm=bold ctermfg=white guifg=Orange
hi Identifier	  term=underline ctermfg=white  guifg=#DBCA98 gui=italic
...
hi Error		  term=reverse	ctermfg=darkcyan  ctermbg=black  guifg=white	guibg=Black
