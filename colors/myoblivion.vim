...
hi Operator     guifg=#729fcf

" variables
hi Identifier	guifg=#729fcf

" string
hi String		guifg=#DBCF0E

" while, if, return , function
hi Statement	guifg=#ffffff gui=bold

" TRUE, FALSE
hi Constant		guifg=#CD5421 gui=none
...
" numéro de ligne et leur background
hi LineNr		guifg=#535353 guibg=#202020
hi NonText		guifg=#535353 guibg=#202020
hi Folded		guifg=white   guibg=#202020 gui=bold
hi FoldeColumn  guifg=#535353 guibg=#202020 gui=bold
" couleur de la barre verticale de separation
hi VertSplit	guifg=#202020 guibg=#202020 gui=none

" barre de status de fenetre active
hi StatusLine   guifg=#FFFFFF guibg=#3C3C3C gui=bold
" barre de status de fentre inactive
